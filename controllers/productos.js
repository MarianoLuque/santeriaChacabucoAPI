...
const getItems = async (req, res) => {
    try {
        ...
        const data = await productosModel.findAllData(page, limit, categoria, titulo, precio)
        res.send({data})
    } catch (err) {
        console.log(err)
...
const getExcel = async (req, res) => {
    try {
        ...
        const data = await productosModel.findAllData(null, null, categoria, null, null)
        console.log(data)
        let arrayData = []
        let jsonData = {}
        ...
        res.setHeader('Content-Disposition', `attachment; filename=precios${categoria}.xlsx`);
...
module.exports = {getItems, getItem, updateItems, createItems, deleteItems, getExcel}