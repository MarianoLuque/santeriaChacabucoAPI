...
const createItems = async (req, res) => {
    try {
        ...
        const { description, variants, imagesId, price } = req.body;
        const body = { title, description, categoryId, variants, imagesId, price };
...
const updateItems = async (req, res) => {
    try {
        const { id } = req.params;
        const { title, description, categoryId, variants, imagesId, price } = req.body;
        body = { title, description, categoryId, variants, imagesId, price };
