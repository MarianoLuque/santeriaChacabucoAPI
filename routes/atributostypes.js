...
const {validatorCreateItem, validatorGetItem} = require('../validators/atributostypes.js')
const {getItems, getItem, createItems, updateItems, deleteItems} = require('../controllers/atributostypes.js')
